...
export function MonthlyPageTabs({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="monthly-work-links flex flex-wrap items-center gap-2 rounded-xl bg-[var(--tds-grey-100)] px-3 py-2 text-sm">
      ...
      <section className="monthly-workspace" aria-label="월간 재무 작업">
      <details className="monthly-section" open>
        <summary><strong>이번 달 거래</strong> <span>예정 거래를 확정하거나 이번 달에서 제외해요.</span></summary>
      ...
      <details className="monthly-section">
        <summary><strong>전체 거래</strong> <span>조건을 걸어 과거·현재 거래를 찾아요.</span></summary>
      ...
      <details className="monthly-section">
        <summary><strong>예산 확인</strong> <span>선택한 달의 예산과 실제 지출을 비교해요.</span></summary>
