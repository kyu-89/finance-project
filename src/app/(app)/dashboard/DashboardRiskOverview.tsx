...
export function DashboardRiskOverview({ insurances }: { insurances: Insurance[] }) {
  ...
  return <div className="home-html-risk-view">
    <div className="home-risk-intro"><div><p className="home-eyebrow">리스크 · 혜택</p><h2>놓치면 손해 보는 보험 일정을 먼저 확인하세요</h2><p>보험료 부담과 만기 일정을 한곳에서 점검하고 필요한 관리를 바로 시작할 수 있습니다.</p></div><Link href="/finance/insurances" prefetch className="home-html-link tds-text-link">보험 관리하기 →</Link></div>
