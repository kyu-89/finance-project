...
export default async function DashboardPage() {
  ...
  return <div data-page="home" className="tds-page home-page">
    <header className="tds-page-header"><div><p className="tds-eyebrow">우리집 가계부</p><h1 className="tds-title">우리 집 재무 현황</h1><p className="tds-page-subtitle">기준 월: {monthLabel(month)} · 확정된 거래와 자산 현황을 한눈에 보여드려요.</p></div></header>
