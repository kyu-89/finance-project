...
export function LoanManager({ loans, members, today }: { loans: Loan[]; members: HouseholdMember[]; today: string }) {
  ...
  return <div className="flex flex-col gap-5"><form action={action} className="tds-card grid gap-4 p-5 md:grid-cols-2 xl:grid-cols-4"><div className="md:col-span-2 xl:col-span-4"><FormMessage result={state} /></div>
