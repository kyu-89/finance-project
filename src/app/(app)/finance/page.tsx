  ...
  return (
    <div className="tds-page">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <Link href="/finance/loans" className="tds-card p-6 transition hover:-translate-y-0.5 hover:shadow-lg"><span className="text-sm font-semibold text-[var(--tds-blue-500)]">사용 가능</span><h2 className="mt-2 text-xl font-bold">대출</h2><p className="mt-2 text-sm text-[var(--tds-grey-700)]">상환방법별 월 원금·이자와 현재 잔액을 계산해요.</p></Link>
        <Link href="/finance/insurances" className="tds-card p-6 transition hover:-translate-y-0.5 hover:shadow-lg"><span className="text-sm font-semibold text-[var(--tds-blue-500)]">사용 가능</span><h2 className="mt-2 text-xl font-bold">보험</h2><p className="mt-2 text-sm text-[var(--tds-grey-700)]">보장내역, 월 보험료와 납입·보장 만기를 관리해요.</p></Link>
      </div>
    </div>
  );
}
