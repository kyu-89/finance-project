  ...
  return (
    <div className="tds-page">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="tds-card p-6 opacity-70"><span className="text-sm font-semibold text-[var(--tds-grey-500)]">순차 개발 중</span><h2 className="mt-2 text-xl font-bold">예·적금·대출·보험</h2><p className="mt-2 text-sm text-[var(--tds-grey-700)]">상품 계산과 월간 반복거래까지 연결할 예정이에요.</p></div>
      </div>
    </div>
  );
}
