...
function LoginForm() {
  ...
  return (
    <main className="auth-shell">
      ...
      <div><p className="mb-2 text-sm font-semibold text-[var(--tds-blue-500)]">우리집 재무</p><h1 className="tds-title">다시 만나요</h1><p className="mt-2 text-sm text-[var(--tds-grey-700)]">우리 집 돈의 흐름과 자산을 이어서 살펴보세요.</p></div>
      {justSignedUp && (
